	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="tests" Type="Folder">
			...
			<Item Name="LibReader" Type="Folder">
				<Item Name="testCase" Type="Folder">
					<Item Name="event" Type="Folder">
						<Item Name="testGetViSalEvent.vi" Type="VI" URL="../../tests/LibReader/testCase/testGetViSalEvent.vi"/>
						<Item Name="testGetViLogEvent.vi" Type="VI" URL="../../tests/LibReader/testCase/testGetViLogEvent.vi"/>
						<Item Name="testGetViGetEvent.vi" Type="VI" URL="../../tests/LibReader/testCase/testGetViGetEvent.vi"/>
						<Item Name="testGetDataTypeEvent.vi" Type="VI" URL="../../tests/LibReader/testCase/testGetDataTypeEvent.vi"/>
					</Item>
					<Item Name="telemetry" Type="Folder">
						<Item Name="testGetViSalTelSub.vi" Type="VI" URL="../../tests/LibReader/testCase/testGetViSalTelSub.vi"/>
						<Item Name="testGetViPutSample.vi" Type="VI" URL="../../tests/LibReader/testCase/testGetViPutSample.vi"/>
						<Item Name="testGetViGetSample.vi" Type="VI" URL="../../tests/LibReader/testCase/testGetViGetSample.vi"/>
						<Item Name="testGetDataTypeTel.vi" Type="VI" URL="../../tests/LibReader/testCase/testGetDataTypeTel.vi"/>
						<Item Name="testGetViGetNextSample.vi" Type="VI" URL="../../tests/LibReader/testCase/testGetViGetNextSample.vi"/>
					</Item>
					<Item Name="testGetEvent.vi" Type="VI" URL="../../tests/LibReader/testCase/testGetEvent.vi"/>
					<Item Name="testGetTel.vi" Type="VI" URL="../../tests/LibReader/testCase/testGetTel.vi"/>
					<Item Name="testSetLvLib.vi" Type="VI" URL="../../tests/LibReader/testCase/testSetLvLib.vi"/>
					<Item Name="testGetViCheckCallbacks.vi" Type="VI" URL="../../tests/LibReader/testCase/testGetViCheckCallbacks.vi"/>
					<Item Name="testGetViRelease.vi" Type="VI" URL="../../tests/LibReader/testCase/testGetViRelease.vi"/>
					<Item Name="testGetViConnect.vi" Type="VI" URL="../../tests/LibReader/testCase/testGetViConnect.vi"/>
				</Item>
			...
			<Item Name="VariantTool" Type="Folder">
				<Item Name="testCase" Type="Folder">
					<Item Name="testGetValFromVariant.vi" Type="VI" URL="../../tests/VariantTool/testCase/testGetValFromVariant.vi"/>
				</Item>
				<Item Name="testVariantTool.vi" Type="VI" URL="../../tests/VariantTool/testVariantTool.vi"/>
			</Item>
			<Item Name="CmpTool" Type="Folder">
				<Item Name="testCase" Type="Folder">
					<Item Name="testCheckData.vi" Type="VI" URL="../../tests/CmpTool/testCase/testCheckData.vi"/>
				</Item>
				<Item Name="testCmpTool.vi" Type="VI" URL="../../tests/CmpTool/testCmpTool.vi"/>
			</Item>
		...
		<Item Name="CmpTool" Type="Folder">
			...
			<Item Name="checkData_summaryState.vi" Type="VI" URL="../CmpTool/checkData_summaryState.vi"/>
			<Item Name="checkData_priority.vi" Type="VI" URL="../CmpTool/checkData_priority.vi"/>
		</Item>
